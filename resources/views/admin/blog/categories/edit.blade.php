            ...
            <div class="row">
                <div class="col-lg-4">
                    <p class="fs-sm text-muted">
                        Editá el nombre, el slug o el estado de esta categoría del blog.
                    </p>
                    @if ($errors->any())
                ...
                <div class="col-lg-8 space-y-5">
                    <form action="{{ route('admin.blog.categories.update', $category) }}" method="POST">
                        ...
                        <div class="form-check form-switch mb-3">
                            <input type="checkbox" class="form-check-input" id="activo" name="activo" value="1" {{ old('activo', $category->activo) ? 'checked' : '' }}>
