        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            ...
            <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item" aria-current="page">{{ $perfil->nombre }}</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <form action="{{ route('admin.perfiles.update', $perfil) }}" method="POST">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" value="{{ old('nombre', $perfil->nombre) }}" required>
                    </div>
                </div>
                                ...
                                <td style="width: 40px;">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="menus[]" value="{{ $menu->id }}"
                                            {{ $perfil->menus->contains($menu->id) ? 'checked' : '' }}>
                                    </div>
                                </td>
