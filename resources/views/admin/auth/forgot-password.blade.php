                ...
                <div class="p-4 p-xl-5 flex-grow-1 d-flex align-items-center">
                    <div class="w-100">
                        ...
                        <p class="text-white-75 me-xl-8 mt-2">
                            Recupera el acceso a tu cuenta ingresando tu correo electrónico.
                        </p>
                    </div>
                </div>
                ...
                <div class="p-4 w-100 flex-grow-1 d-flex align-items-center">
                    <div class="w-100">
                        ...
                        <div class="text-center mb-5">
                            <p class="mb-3">
                                <i class="fa fa-2x fa-unlock-alt text-primary-light"></i>
                            </p>
                            <h1 class="fw-bold mb-2">Recuperar Contraseña</h1>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <div>
                                            <button type="submit" class="btn btn-lg btn-alt-primary">
                                                <i class="fa fa-fw fa-envelope me-1 opacity-50"></i> Enviar Email
                                            </button>
                                        </div>
                                    </div>
